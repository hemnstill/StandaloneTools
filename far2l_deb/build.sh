...
cmake -DUSEWX=no -DNETROCKS=no -DUSEUCD=no -DCOLORER=no -DMULTIARC=no -DCMAKE_EXE_LINKER_FLAGS="-lpthread -l:uchardet.a -l:execinfo.a -static-libgcc -static-libstdc++" -DCMAKE_BUILD_TYPE=Release .
